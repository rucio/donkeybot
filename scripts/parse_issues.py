...
def main():
    # Parse cli arguments
    parser = argparse.ArgumentParser(description='''This is the script responsible for parsing GitHub issues''')
    ...
    parser.parse_dataframe(raw_issues_data, db=data_storage, issues_table_name=issues_table)
