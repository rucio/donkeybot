...
def _remove_names(text):
    ...
    This also chunks together other named entities and might create problems
...
random_text = '''House Speaker Vasilis Di Example became animated Tuesday over the proposed Keystone Pipeline, castigating the Obama administration for not having approved the project yet.
Republican House Speaker Vasilis Di Example says there's "nothing complex about the Keystone Pipeline," and that it's time to build it.
