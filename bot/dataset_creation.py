...
from eparser import EmailParser
# general python
import pickle
import re
import hashlib
...
def get_questions():
    ...
    print(f'Total emails_with_questions:{emails_with_questions}')
    db.close_connection() 
    return
...
def main():
    ...
    # Step 3 is to create the questions.db which holds the question and their context
    get_questions()
    return
